...
var orderService = service.ServiceGroupApp.LgjxServiceGroup.OrderService
...
// @Param data body lgjx.Order true "创建Order"
...
// @accept application/json
// @Produce application/json
// @Param data body lgjx.Order true "删除Order"
...
// @accept application/json
// @Produce application/json
// @Param data body lgjx.Order true "更新Order"
...
// @accept application/json
// @Produce application/json
// @Param data query lgjx.Order true "用id查询Order"
...
// @accept application/json
// @Produce application/json
// @Param data query lgjxReq.OrderSearch true "分页获取Order列表"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"获取成功"}"
