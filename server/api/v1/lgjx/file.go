...
var fileService = service.ServiceGroupApp.LgjxServiceGroup.FileService
...
// @Param data body lgjx.File true "创建File"
...
// @accept application/json
// @Produce application/json
// @Param data body lgjx.File true "删除File"
...
// @accept application/json
// @Produce application/json
// @Param data body lgjx.File true "更新File"
...
// @accept application/json
// @Produce application/json
// @Param data query lgjx.File true "用id查询File"
...
// @accept application/json
// @Produce application/json
// @Param data query lgjxReq.FileSearch true "分页获取File列表"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"获取成功"}"
